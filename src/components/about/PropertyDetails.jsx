...
// ✅ Reusing your common container for consistent layout
import houseIcon from "../../assets/images/commonHouseIcon.png"; 
// ✅ Importing the house icon
...
const PropertyDetails = () => {
  return (
    <Container>
      ...
      <div className="font-nunito py-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            {/* Placeholder text – replace with real content later */}
            Discover thoughtfully designed living spaces tailored for comfort and style.
          </p>
