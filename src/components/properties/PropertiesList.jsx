    ...
    <Container>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-20 mb-25">
        ...
        <div>
          ...
          <aside className="bg-white rounded-sm shadow-md px-6 py-4">
            {/* Property Type */}
        ...
        <section className="lg:col-span-2 space-y-6">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <select className="border border-gray-300 rounded-sm px-2 py-1 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                  <option>12</option>
                  <option>24</option>
                  <option>48</option>
                </select>
              ...
              <div className="flex gap-2">
                {/* Grid icon button */}
                <button className="p-2 border border-gray-300 rounded-sm shadow-sm hover:bg-orange-500 hover:text-white transition">
                  <FaThLarge className="h-4 w-4 text-gray-600 hover:text-white" />
                </button>

                {/* List icon button */}
                <button className="p-2 border border-gray-300 rounded-sm shadow-sm hover:bg-orange-500 hover:text-white transition">
                  <FaList className="h-4 w-4 text-gray-600 hover:text-white" />
                </button>
              </div>
            </div>
          </div>
          ...
          {/* Search bar */}
          <div className="flex items-center w-full bg-gray-100 border border-gray-300 rounded-sm px-3 py-2 mt-10">
            <input
              type="text"
              ...
              >
                ...
                <div className="p-4 font-nunito">
                  ...
                  <div className="flex gap-3 mt-4">
                    <button className="p-2 border rounded-sm shadow-sm hover:bg-orange-500 hover:text-white transition">
                      <FaExpand />
                    </button>
                    <button className="p-2 border rounded-sm shadow-sm hover:bg-orange-500 hover:text-white transition">
                      <FaHeart />
